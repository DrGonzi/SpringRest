package com.wildcodeschool.booktest.RestBook.controllers;

import org.springframework.web.bind.annotation.RestController;

import com.wildcodeschool.booktest.RestBook.entities.Book;
import com.wildcodeschool.booktest.RestBook.repositories.BookRepository;
...
public class BookController {
    ...
    public List<Book> search(@RequestBody Map<String, String> body){
        ...
        return bookRespository.findByTitleContainingOrAuthorContainingOrDescriptionContaining(searchTerm, searchTerm, searchTerm);
    }
